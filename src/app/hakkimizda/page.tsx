        ...
        <section className="bg-gradient-to-br from-[#14543c] to-[#0f3d2a] py-12 sm:py-16 lg:py-20">
          <div className="container mx-auto container-responsive">
            <div className="text-center">
              ...
              <nav className="mt-4 sm:mt-6">                <ol className="flex justify-center items-center space-x-2 text-sm sm:text-base text-[#f29b24]">
                  <li>
        ...
        <section className="py-8 sm:py-12 lg:py-16">
          <div className="container mx-auto container-responsive">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              ...
              {/* Sağ Taraf - Görsel ve İstatistikler */}
              <div className="space-y-6 lg:space-y-8">
                <div className="relative">
                  <Image
                    src="/assets/images/pide1.jpg"
                    alt="Pide Hazırlama Süreci"
                    width={600}
                    height={400}
