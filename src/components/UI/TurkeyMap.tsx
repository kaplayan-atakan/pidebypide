...
// Türkiye haritası SVG path verileri
const turkeyPaths = {
  // Ardahan
...
const cityNames: Record<string, string> = {
  ...
  TR34: "İstanbul",
  TR59: "Tekirdağ"
  // Burada tüm şehirleri ekleyeceğiz...
};
...
export default function TurkeyMap({
  ...
  return (
    ...
    >
      <g id="features">
        {Object.entries(turkeyPaths).map(([svgId, pathData]) => (
          <path
            key={svgId}
            d={pathData}
            id={svgId}
            style={getPathStyle(svgId)}
            onMouseEnter={() => handleMouseEnter(svgId)}
            onMouseLeave={handleMouseLeave}
            onClick={() => handleSvgCityClick(svgId)}
            role="button"
            aria-label={cityNames[svgId] || svgId}
          />
        ))}
      </g>
    </svg>
          ...
          id="TR73" 
          style={getPathStyle('TR73')}
          onMouseEnter={() => handleMouseEnter('TR73')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR73')}
          role="button"
          aria-label="Şırnak"
        />
        ...
        <path 
          ...
          id="TR30" 
          style={getPathStyle('TR30')}
          onMouseEnter={() => handleMouseEnter('TR30')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR30')}
          role="button"
          aria-label="Hakkari"
        />
        ...
        <path 
          ...
          id="TR76" 
          style={getPathStyle('TR76')}
          onMouseEnter={() => handleMouseEnter('TR76')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR76')}
          role="button"
          aria-label="Iğdır"
        />
        ...
        <path 
          ...
          id="TR04" 
          style={getPathStyle('TR04')}
          onMouseEnter={() => handleMouseEnter('TR04')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR04')}
          role="button"
          aria-label="Ağrı"
        />
        ...
        <path 
          ...
          id="TR65" 
          style={getPathStyle('TR65')}
          onMouseEnter={() => handleMouseEnter('TR65')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR65')}
          role="button"
          aria-label="Van"
        />
        ...
        <path 
          ...
          id="TR34" 
          style={getPathStyle('TR34')}
          onMouseEnter={() => handleMouseEnter('TR34')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR34')}
          role="button"
          aria-label="İstanbul"
        />
        ...
        <path 
          ...
          id="TR06" 
          style={getPathStyle('TR06')}
          onMouseEnter={() => handleMouseEnter('TR06')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR06')}
          role="button"
          aria-label="Ankara"
        />
        ...
        <path 
          ...
          id="TR01" 
          style={getPathStyle('TR01')}
          onMouseEnter={() => handleMouseEnter('TR01')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR01')}
          role="button"
          aria-label="Adana"
        />

        {/* Burada space tasarrufu için sadece ana şehirleri ekledim */}
        {/* Gerçek implementasyonda tüm 81 şehir eklenecek */}
        
        {/* İzmir - TR35 - Kısaltılmış versiyon */}
        <path 
          ...
          id="TR35" 
          style={getPathStyle('TR35')}
          onMouseEnter={() => handleMouseEnter('TR35')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR35')}
          role="button"
          aria-label="İzmir"
        />

        {/* Bursa - TR16 - Kısaltılmış versiyon */}
        <path 
          d="M247.9 115.4l0.2 1.5 0.5 1.3-2.5 1.4-1.1 0.8-0.9 1-0.9 1.7-0.2 2-0.5 1.7-0.6 1.5 0.2 1.9 1.1 1.4 0.2 1.7-0.8 1.7-4.6 4.9-1.3 6.2 0 3.1 2.5 3.6 1.3 1 0.6 3.1z" 
          id="TR16" 
          style={getPathStyle('TR16')}
          onMouseEnter={() => handleMouseEnter('TR16')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR16')}
          role="button"
          aria-label="Bursa"
        />

        {/* Antalya - TR07 - Kısaltılmış versiyon */}
        <path 
          d="M216.3 375.3l1.3-0.7 0.9-1.2 0.3-1.5 0-0.8 0-0.7 0.4-0.9 0.3-1 1.6-3.2 3-1.2 1.4 0.6z" 
          id="TR07" 
          style={getPathStyle('TR07')}
          onMouseEnter={() => handleMouseEnter('TR07')}
          onMouseLeave={handleMouseLeave}
          onClick={() => handleSvgCityClick('TR07')}
          role="button"
          aria-label="Antalya"
        />
      </g>
